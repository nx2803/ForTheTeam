                            ...
                            <AnimatePresence>
                                {isDropdownOpen && (
                                    ...
                                    >
                                        ...
                                        <div className="py-2">
                                            <button
                                                className="w-full px-4 py-2 text-left text-zinc-300 hover:bg-zinc-800 hover:text-white transition-colors font-mono text-sm uppercase tracking-wider flex items-center gap-3"
                                                onClick={() => {
                                                    setIsDropdownOpen(false);
                                            ...
                                            <button
                                                ...
                                                className="w-full px-4 py-2 text-left text-zinc-300 hover:bg-red-900/20 hover:text-sport-red transition-colors font-mono text-sm uppercase tracking-wider flex items-center gap-3 border-t border-zinc-800"
                                            >
                                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
